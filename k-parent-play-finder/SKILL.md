...
description: 대한민국 부모를 위한 아이 놀거리·실내외 놀이 장소 추천 스킬. 행안부 어린이놀이시설, 전국도시공원표준데이터, 한국관광공사 TourAPI(지역기반/위치기반 관광지·문화시설·레포츠)를 결합해 연령·날씨·이동거리에 맞는 놀이 장소를 찾고 비용/연령대/주차 정보를 정리한다. "아이랑 갈 만한 곳", "주말 실내 놀이터", "근처 어린이공원", "비 오는 날 아이랑" 같은 요청에 사용. 날짜가 박힌 축제는 k-parent-festival-finder, 1박 이상·타지역 코스는 k-parent-travel-recommender, 접수형 강좌는 k-parent-culture-center-events.
---
